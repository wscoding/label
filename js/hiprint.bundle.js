...
var hiprint = function (t) {
    ...
    var i = function () {
        ...
        B = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        页面校验码\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="Html-print-2020" class="auto-submit" disabled="disabled">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        F = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        版本校验码\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="Coor-jmw.star" class="auto-submit" disabled="disabled">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        L = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        测试校验码\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="Sta010021700" class="auto-submit" disabled="disabled">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        A = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        数组校验码\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="Sta011025700" class="auto-submit"  disabled="disabled">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        N = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        偏移检验|PT\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="默认|0pt|zero" class="auto-submit" disabled="disabled">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        st = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        配置校验码\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="Concio-GET-1.0.0.8" class="auto-submit" disabled="disabled">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        yt = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        行样式函数\n        </div>\n        <div class="hiprint-option-item-field">\n        <textarea style="height:80px;" placeholder="请输入内容" class="auto-submit"></textarea>\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("textarea").val();
                if (t) return t;
            }, t.prototype.setValue = function (t) {
                ...
                if ("text" == s) a.html(p); else {
                    if ("barcode" == s) {
                        ...
                        try {
                            ...
                            console.log(t), a.html("条形码格式，拖拽到位后显示");
                        }
                    }
